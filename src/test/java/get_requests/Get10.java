...
public class Get10 extends GoRestBaseUrl {
     ...
     */
        ...
        public void get01(){
            ...
            GoRestTestData dataKey = new GoRestTestData();//gerekli methodun çagrılması için obje oluşturdum.
            Map<String , String> dataKeyMap = dataKey.DataKeyMap("Mr. Gita Menon", "gita_menon_mr@bayer.com",
                    "female","inactive");//iç map oluşturdum
            ...
            Map<String, Object> actualDataMap = response.as(HashMap.class);//json formatından java objesine çevirme de serialization

            //4. Step: Do Assertion
            assertEquals(expectedData.get("meta"),actualDataMap.get("meta"));
            assertEquals(dataKeyMap.get("name"),((Map)actualDataMap.get("data")).get("name"));//önce data elementine ulaşıp
            //buradan aldıgım objeyi map formatına cast ediyorum
