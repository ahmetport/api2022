...
public class Post01 extends JsonplaceholderBaseUrls {
    ...
    public void post01(){
        ...
        Map<String, Object> expectedDataMap = expectedData.expectedDataWithAllKeys(55, "Tidy your room",
                false);
        ...
        //4. Step: Do Assertion
        Map<String, Object> actualDataMap = response.as(HashMap.class);//response tipi datamı map çeviriyorum
