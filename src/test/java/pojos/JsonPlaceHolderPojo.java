package pojos;
    ...
    @JsonIgnoreProperties(ignoreUnknown = true)//umursama atla methodu bu anatotıons kullanarak çagırdıgım data bekledigim datadan
    //farklı olursa onu atla takma demek
